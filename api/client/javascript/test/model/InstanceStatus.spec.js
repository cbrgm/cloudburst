...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Cloudburst.InstanceStatus();
  });
  ...
  describe('InstanceStatus', function() {
    it('should create an instance of InstanceStatus', function() {
      ...
      //var instane = new Cloudburst.InstanceStatus();
      //expect(instance).to.be.a(Cloudburst.InstanceStatus);
    });

    it('should have the property agent (base name: "agent")', function() {
      // uncomment below and update the code to test the property agent
      //var instance = new Cloudburst.InstanceStatus();
