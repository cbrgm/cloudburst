...
Cloudburst - JavaScript client for cloudburst
...
To use the link you just defined in your project, switch to the directory you want to use your cloudburst from, and run:
...
```javascript
var Cloudburst = require('cloudburst');
